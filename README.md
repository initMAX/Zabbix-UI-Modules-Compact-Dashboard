...
<div align="center">
    <h1>
        Compact Dashboard <!-- !!! change version !!! -->
    </h1>
    <h4>
        Remove spacing between widgets <!-- !!! change version !!! -->
    </h4>
    <br>
    <img alt="Static Badge" src="https://img.shields.io/badge/Required%20Zabbix%20version-7.0-red"> <!-- !!! change version !!! -->
    <img alt="Static Badge" src="https://img.shields.io/badge/Required%20php%20version-7.4-blue"> <!-- !!! change version !!! -->
    <h3>
        <a href="#description">Description</a> •<!-- !!! change list !!! -->
        <a href="#installation">Installation</a>
    </h3>
    <br>
    <img src="./.readme/screen/dashboard.gif" width="1000"> <!-- !!! change version !!! -->
</div>
<br>
<br>
...
- Save every pixel of screen space
...
- Clone repository on your server <!-- !!! repository !!! -->
    ```sh
    git clone https://git.initmax.cz/initMAX-Public/Zabbix-UI-Modules-Compact-Dashboard.git
    ``` 
...
- Change the owner of directory to your web user with `chown`
  - default OS users
    - nginx
        ```sh
        chown nginx:nginx ./Zabbix-UI-Modules-Compact-Dashboard
        ``` 
    - apache (RHEL)
        ```sh
        chown apache:apache ./Zabbix-UI-Modules-Compact-Dashboard
        ``` 
    - apache (DEB)
        ```sh
        chown www-data:www-data ./Zabbix-UI-Modules-Compact-Dashboard
        ``` 
